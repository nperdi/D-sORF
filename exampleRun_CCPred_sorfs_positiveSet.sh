...
inputFileName="/mnt/raid1/perdikopn/projects/dsorf/2022_ver_june/data/otherTestingDataset/datasets/Testing_Sets/CPPred/Human-sORF-Testing/Human.small_coding_RNA_test.fa"
...
outputDir="202_CPPred_positive_sorfs/"
numOfProcess=40
